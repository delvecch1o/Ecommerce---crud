                ...
                <div className="card-body">
                    ...
                    <form onSubmit={updateProduct} encType="multipart/form-data">
                        ...
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane card-body bordere fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div className="tab-pane card-body bordere fade" id="seotags" role="tabpanel" aria-labelledby="seotags-tab">
                            ...
                            <div className="tab-pane card-body bordere fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
